...
void td32_14()
{
    ...
    TCanvas *c4 = new TCanvas("c4", "DNL 32/14");
    c4->Divide(1,2);
   	...
   	// Histograms
   	TH1F *h1 = new TH1F("h1", "DNL (channel 32, del. 14, EVENS)", Nbins, xMin, xMax) ;   
   	TH1F *h2 = new TH1F("h2", "DNL (channel 32, del. 14, ODDS)", Nbins, xMin, xMax) ;   
   	// input files
   	ifstream f1("data/data32_14.csv") ; 
