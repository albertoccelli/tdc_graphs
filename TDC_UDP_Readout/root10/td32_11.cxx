...
void td32_11()
{
    ...
    TCanvas *c1 = new TCanvas("c1", "DNL 32/11");
    c1->Divide(1,2);
   	...
   	// Histograms
   	TH1F *h1 = new TH1F("h1", "DNL (channel 32, del. 11, EVENS)", Nbins, xMin, xMax) ;   
   	TH1F *h2 = new TH1F("h2", "DNL (channel 32, del. 11, ODDS)", Nbins, xMin, xMax) ;   
   	// input files
   	ifstream f1("data/data32_11.csv") ; 
