...
void td32_13()
{
    ...
    TCanvas *c3 = new TCanvas("c3", "DNL 32/13");
    c3->Divide(1,2);
   	...
   	// Histograms
   	TH1F *h1 = new TH1F("h1", "DNL (channel 32, del. 13, EVENS)", Nbins, xMin, xMax) ;   
   	TH1F *h2 = new TH1F("h2", "DNL (channel 32, del. 13, ODDS)", Nbins, xMin, xMax) ;   
   	// input files
   	ifstream f1("data/data32_13.csv") ; 
